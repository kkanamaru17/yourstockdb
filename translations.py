translations = {
    'en': {
        ...
        'total_capital_gain': 'Total Capital Gain',
        ...
        'gain_explanation': '*Capital gain = return from share price change, Income gain = return from dividends',
        ...
        'portfolio': 'Portfolio',
        'back_to_stock_db': 'Back to Stock DB',
        'portfolio_performance_today': 'Portfolio',
    ...
    'jp': {
        ...
        'shortest_held': '最短保有',
        'days': '日',
        'portfolio_performance': 'パフォーマンス',
        'gain_explanation': '*キャピタルゲイン = 株価変動による収益、インカムゲイン = 配当による収益',
        # translations for stockan page
        'stock_analysis': '株式分析',
        'back_to_stock_db': '株式DBに戻る',
        'stock_ticker': '銘柄コード',
        ...
        'portfolio': 'ポートフォリオ',
        'back_to_stock_db': '株式DBに戻る',
        'portfolio_performance_today': 'パフォーマンス',
        'nikkei_225': '日経225',
        'sp_500': 'S&P 500',
        'as_of': '日付',
